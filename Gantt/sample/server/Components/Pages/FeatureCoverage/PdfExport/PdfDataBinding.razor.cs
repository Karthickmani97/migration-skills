using static SyncfusionBlazorApp.Components.Pages.FeatureCoverage.SplitTask.Split_Task_Method;
using Syncfusion.Blazor.Gantt;
using System.Dynamic;
namespace SyncfusionBlazorApp.Components.Pages.FeatureCoverage.PdfExport
{
    public partial class PdfDataBinding
    {
        ...
        private List<string> IdTypes = new List<string> { "int", "object", "string", "guid", "expando", "dynamic object", "custom adaptor", "rtl" };
