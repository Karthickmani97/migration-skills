...
test('2-Editing sample - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'editing?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Screenshot validation-On intial load Editing sample has fluent 2 theme
    expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
});

test('3-Add dialog tab general - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'editing?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
...
test('4-Add dialog tab dependency - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'editing?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Click the Add button on toolbar to open the dialog tab
    await page.locator("(//span[text()='Add'])[1]").click();
...
test('5-Dependency add tab- fluent2-highcontrast', async ({ page }) => {
...
test('6-Delete dialog dependency - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'editing?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Click the child record on grid side to delete.
    await page.locator("(//td[contains(@aria-label,'Obtain permits')])[1]").click();
    await page.waitForTimeout(500);
...
test('7-Focusing on cell-edit - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'editing?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Double click the cell to idicate it is editable
    await page.locator("(//td[contains(@aria-label,'Obtain permits')])[1]").dblclick();
    await page.waitForTimeout(2000);
    //Screenshot validation-The cell should be in editable state
    expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
});

test('8-Open filter menu - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'filtering?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
...
test('9-Open filter menu options - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'filtering?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
...
test('10-Check filter icon after filtering - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'filtering?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Click the filter icon on Task ID to open filter menu
    await page.locator('(//div[contains(@class,"e-filtermenudiv")])[1]').click();
...
test('11-Row selection - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'selection?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
...
//https://dev.azure.com/EssentialStudio/testing/_workitems/edit/907094
test('12-Cell selection - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'selection?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
...
test('13-Scheduling concept sample - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'scheduling-mode?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Screenshot validation-initial load of sample is visible
    expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
});

test('14-Scheduling concept sample - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'holidays?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Screenshot validation-initial load of sample is visible
    expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
});

test('15-Unscheduled sample - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'unscheduled-task?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Screenshot validation-initial load of sample is visible
    expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
});

test('16-Baseline sample - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'baseline?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Screenshot validation-initial load of sample is visible
    expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
});

test('17-Eventmarkers sample - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'eventmarkers?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Screenshot validation-initial load of sample is visible
    expect(await page.locator('.e-gantt').first().screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
});

test('18-Critical path sample - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'criticalpath?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Screenshot validation-initial load of sample is visible
    expect(await page.locator('.container-fluid').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
});

test('19-column template sample - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'column-template?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Screenshot validation-initial load of sample is visible
    expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
});
...
test('20-Column menu options', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'column-menu?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
...
test('21-Resourceview sample - fluent2-highcontrast', async ({ page }) => {
...
test('22-Resources tab - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'resource-view?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    ...
    await page.locator("(//td[text()='Martin Tamer'])[1]").click();
    await page.waitForTimeout(500);
    //Screenshot validation-Resources dialog tab is opened and visible
    expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
});

test('23-Header template - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'header-template?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Screenshot validation-On Initial load of the sample it should be visible
    expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
});

test('24-Taskbar template - fluent2-highcontrast', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'taskbar-template?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Screenshot validation-On Initial load of the sample it should be visible
    expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
});

// test('25-Taskbar resizer icon visibility in Touch mode', async ({ page }) => {
//     await page.goto(Helper.baseUrl + 'editing?theme=fluent2-highcontrast');
//     await page.waitForTimeout(2000);
//     //Click the settings 
...
// test('28-Switch to Resource view and change Records ', async ({ page }) => {
//     await page.goto(Helper.baseUrl + 'overview?theme=fluent2-highcontrast');
//     await page.waitForTimeout(2000);
//     //Click the settings
//     await page.locator('(//span[contains(@class,"settings")])[2]').click();
...
// test('29-Change View type to Resource view', async ({ page }) => {
//     await page.goto(Helper.baseUrl + 'overview?theme=fluent2-highcontrast');
//     await page.waitForTimeout(2000);
//     //Click the settings
//     await page.locator('(//span[contains(@class,"settings")])[2]').click();
...
// test('31-Hover enabled on the Grid side', async ({ page }) => {
//     await page.goto(Helper.baseUrl + 'overview?theme=fluent2-highcontrast');
//     await page.waitForTimeout(2000);
...
// test('32-Hover enabled on the Chart side', async ({ page }) => {
//     await page.goto(Helper.baseUrl + 'overview?theme=fluent2-highcontrast');
//     await page.waitForTimeout(2000);
//     //Hover over the child record on Chart side of the component
//      await page.mouse.move(595, 547);
...
test('34-Collapse all Records and Add Task Above', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'split-tasks?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
...
test('35-Collapse all Records, Add Task Below', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'split-tasks?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
...
test('38-Cancel the record after Add and Edit', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'split-tasks?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
...
test('39-Edit the parent record with Null Value', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'split-tasks?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
...
test('42-Work time range customized Duration the hours', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'working-time-range?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Double click the duration on child record
    await page.locator('(//td[contains(@class, "e-rowcell")])[13]').dblclick();
    await page.waitForTimeout(1000);
    //Enter the number of hours
    await page.locator('(//input[contains(@class, "e-lib e-input")])[1]').fill('2 Hours');
    await page.waitForTimeout(500);
    //Press the Enter key on the keyboard
    await page.keyboard.press('Enter');
    await page.waitForTimeout(1000);
...
test('43-Delete dependency - toolbar edit', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'editing?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Click the record.
    await page.locator("(//span[text()='Finalize planning'])[1]").click();
    await page.waitForTimeout(500);
    //Click Edit button
    await page.locator('(//span[contains(@class,"edit")])').click();
    await page.waitForTimeout(500);
    ...
    await page.locator("(//td[contains(@class,'rowcell')])[282]").click();
    await page.waitForTimeout(500);
...
test('44-Collapse all records ,Expand records', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'resource-view?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Click to collapse all
    await page.locator('(//span[contains(@class, "collapseall")])').click();
...
test('45-Edit the record when open the dialog', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'multi-taskbar?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    ...
    await page.locator('(//input[contains(@class,"e-textbox e-lib")])[1]').fill('Location');
    await page.waitForTimeout(500);
    //Click save button
    await page.locator("(//button[text()='Save'])").click();
    await page.waitForTimeout(2000);
...
test('46-Fixed duration: Add new task record with resources', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'resource-allocation?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
...
test('47-Select the records after edit dependency', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'keyboard-navigation?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Click the child record
    ...
    await page.locator('(//input[contains(@class,"e-lib e-input")])[1]').fill('3SF');
    await page.waitForTimeout(500);
...
test('48-Extend the cell selection ', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'keyboard-navigation?theme=fluent2-highcontrast');
    await page.waitForTimeout(1000);
    //Click the duration
    ...
    await page.locator('(//input[contains(@class,"e-textbox e-lib")])[1]').fill('Concept');
    await page.waitForTimeout(500);
...
test('49-Cell edit the records by use of Tab key', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'keyboard-navigation?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    //Click the child record
    await page.locator('(//td[contains(@class,"rowcell")])[2]').click();
...
test('50-Autofit this column and Filter End date  with Null', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'column-menu?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
...
test('51-Autofill all columns and Filter startdate with Equal', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'column-menu?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    ...
    await page.locator('(//input[contains(@class,"e-lib e-input")])[2]').fill('4/19/2021');
    await page.waitForTimeout(500);
    //Click Filter button
...
test('52-Freeze Start date and Dependency column', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'frozen-column?theme=fluent2-highcontrast')
    await page.waitForTimeout(1000);
...
// //https://dev.azure.com/EssentialStudio/Ej2-Web/_workitems/edit/903966
// test('53-BUG-903966-select Work week to show the dropdown', async ({ page }) => {
//     await page.goto(Helper.baseUrl + 'overview?theme=fluent2-highcontrast');
//     await page.waitForTimeout(2000);
//     //Click the settings button
//     await page.locator('(//span[contains(@class, "settings")])[2]').click();
//     await page.waitForTimeout(500);
//     //Click the work week to select to check on day'Monday'
//     await page.locator('(//input[contains(@class, "multiselect")])[1]').click();
//     await page.waitForTimeout(2000);
//     //Screenshot validation-The day Monday is visible when click and dropdown is shown
//     expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
// });

//https://dev.azure.com/EssentialStudio/Ej2-Web/_workitems/edit/905569
test('54-BUG-905569-Visibility Issue on the button Clear', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'airline-tracker?fluent2-highcontrast');
    await page.waitForTimeout(4000);
    //Screenshot validation-The Clear button on initial load of the sample is visible in theme bootstrap5
    expect(await page.locator('.container-fluid').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
});

// //https://dev.azure.com/EssentialStudio/Ej2-Web/_workitems/edit/905556/
// test('55-BUG-905556-Visibility issue of the icons for expand ', async ({ page }) => {
//     await page.goto(Helper.baseUrl + 'overview?theme=fluent2-highcontrast');
//     await page.waitForTimeout(2000);
//     //Click the collapse all button  
//     await page.locator('(//span[contains(@class, "collapseall")])[1]').click();
//     await page.waitForTimeout(500);
//     //Click the Expandall button 
//     await page.locator('(//span[contains(@class, "expandall")])[1]').click();
//     await page.waitForTimeout(2000);
//     //Screenshot validation-The expand icon is visible
//     expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
//     await page.waitForTimeout(1000);
//     //Hover over the record to show the collapse icon
//     await page.mouse.move(143,421);
//     await page.waitForTimeout(2000);
//     //Screenshot validation-The icon for collapse icon when hovered over is visible
//     expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
// });

// //https://dev.azure.com/EssentialStudio/Ej2-Web/_workitems/edit/905556/
// test('56-BUG-905556-Click the taskbars on the chart', async ({ page }) => {
//     await page.goto(Helper.baseUrl + 'overview?theme=fluent2-highcontrast');
//     await page.waitForTimeout(1000);
//     //Click the taskbar on the split lines
//     await page.locator('(//div[contains(@class, "child")])[2]').click();
//     await page.waitForTimeout(1200);
//     //Screenshot validation-split lines is visible on the chart side when selected
//     expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
// });

// //https://dev.azure.com/EssentialStudio/Ej2-Web/_workitems/edit/903977/
// test('57-BUG-903977-Visibility Issue', async ({ page }) => {
//     await page.goto(Helper.baseUrl + 'overview?theme=fluent2-highcontrast');
//     await page.waitForTimeout(1000);
//     //Double click the child taskbar to open dialog tab
...
//     await page.waitForTimeout(2000);
//     //Screenshot validation-The records from the dropdown for dependency record is visible
//     expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
// });

// //https://dev.azure.com/EssentialStudio/Ej2-Web/_workitems/edit/901555
// test('58-Select the Grid Lines and Hover the text are visible', async ({ page }) => {
//     await page.goto(Helper.baseUrl + 'overview?theme=fluent2-highcontrast');
//     await page.waitForTimeout(2000);
//     //Click the settings
//     await page.locator('(//div[contains(@id,"Settings")])[1]').click();
//     await page.waitForTimeout(500);
//     //Hover to show Grid Lines
//     await page.locator('(//span[contains(@class,"handle")])[1]').hover();
//     await page.waitForTimeout(200);
//     //Screenshot validation-The text are visible when hovered over.
//     expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
// });

// //https://dev.azure.com/EssentialStudio/testing/_workitems/edit/901873
// test('59-Select the Grid Lines and Hover the text are visible', async ({ page }) => {
//     await page.goto(Helper.baseUrl + 'overview?theme=fluent2-highcontrast');
//     await page.waitForTimeout(2000);
//     //Click the settings
//     await page.locator('(//div[contains(@id,"Settings")])[1]').click();
...
//https://dev.azure.com/EssentialStudio/Ej2-Web/_workitems/edit/902346
test('60-Selection date visibility issue', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'editing?theme=fluent2-highcontrast');
    await page.waitForTimeout(1000);
    ...
    await page.locator('(//span[contains(@class,"e-input-group-icon")])[1]').click();
    await page.waitForTimeout(2000);
    //Screenshot validation-The selection is visible
    expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
});

//https://dev.azure.com/EssentialStudio/Ej2-Web/_workitems/edit/921907
test('61-Visibility issue', async ({ page }) => {
    await page.goto(Helper.baseUrl + 'human-resource-management?theme=fluent2-highcontrast');
    await page.waitForTimeout(2000);
    await page.locator('(//td[contains(@class, "e-rowcell")])[12]').click();
    await page.waitForTimeout(200);
    //Click to show the tooltip
    await page.locator('(//div[contains(@class, "e-appointment")])[1]').hover();
    await page.waitForTimeout(2000);
    //Screenshot validation-Image is visible when hovered over
    expect(await page.locator('.container-fluid').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
});

//https://dev.azure.com/EssentialStudio/Ej2-Web/_workitems/edit/926792
test('62-926792-Icon Display Issue When Editing Cell', async ({ page }) => {
    await page.setViewportSize({ width: 1920, height: 1080 });
    await page.goto(Helper.baseUrl + 'resource-allocation?theme=fluent2-highcontrast');
    test.info().annotations.push({ type: 'Sample link', description: 'resource-allocation?theme=fluent2-highcontrast' });
    await page.waitForTimeout(2000);
    //Double click the Task Type
    await page.locator('(//td[contains(@class,"rowcell")])[6]').dblclick();
    await page.waitForTimeout(2000);
    //Screenshot validation-The icon that indicates the dropdown content is visible
    expect(await page.locator('.e-gantt').screenshot()).toMatchSnapshot({ maxDiffPixels: 100 });
});