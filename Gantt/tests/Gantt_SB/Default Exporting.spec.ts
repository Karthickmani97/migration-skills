...
// test('2-Zoom In ,Zoom Fit and click PDF Export', async ({ page }, testInfo) => {
//     await page.goto(Helper.baseUrl + 'exporting?theme=fluent2');
...
// test('3-Zoom Out and click PDF Export', async ({ page }, testInfo) => {
//     await page.goto(Helper.baseUrl + 'exporting?theme=fluent2');
//     await page.waitForTimeout(2000);
...
// test('4-Zoom In and click PDF Export', async ({ page }, testInfo) => {
//     await page.goto(Helper.baseUrl + 'exporting?theme=fluent2');
//     await page.waitForTimeout(2000);
...
// test('5-Zoom Out,Zoom In and click PDF Export', async ({ page }, testInfo) => {
//     await page.goto(Helper.baseUrl + 'exporting?theme=fluent2');
//     await page.waitForTimeout(2000);
//     //Click Zoom Out button on the toolbar
//     await page.locator('(//span[contains(@class, "zoomout")])[1]').click();
...
// test('6-PDF Export for Exporting sample', async ({ page }, testInfo) => {
//     await page.goto(Helper.baseUrl + 'exporting?theme=fluent2');
//     await page.waitForTimeout(2000);
//     // Press the button to download the PDF files    
//     const [download] = await Promise.all([page.waitForEvent('download'),
...
//     //Converts the 1 pages to image format and takes snapshot     
//     for await (const page of doc) {
//     //Screenshot validation-The PDF Image for the record has been uploaded.
//     expect(page).toMatchSnapshot('PdfExport.png', { maxDiffPixels: 100 });
//     }
// }); 

// test('7-CVSExportFile', async ({ page, context }, testInfo) => {
//     await page.goto(Helper.baseUrl + 'exporting?theme=fluent2');
...
//     const ExpectedExportFile = "./tests/ExcelExportFilesDiff2/ExpectedExport2/ExcelFileUploadtry2/CVSExport2.csv";
//     await page.waitForTimeout(500);
...
//   test('8-ExcelFileUpload', async ({ page, context }, testInfo) => {
//     await page.goto(Helper.baseUrl + 'exporting?theme=fluent2');
//     await page.waitForTimeout(4000);
...
//     await page.waitForTimeout(500);
//     // Define where the downloaded excel file will go and get saved 
//     const path = "./tests/file-uploads2/trial2" + download.suggestedFilename();
//     await download.saveAs(path);
//     await page.waitForTimeout(500);
//     // attach the downloaded file to the report 
//     await testInfo.attach('downloaded', { path: path });
//     await page.waitForTimeout(500);
//     // Define the Expected Export File's Path which I want to upload 
//     const ExpectedExportFile = "./tests/ExcelExportFilesDiff1/ExpectedExport1/ExcelFileUploadtry1/Export1.xlsx";
//     await page.waitForTimeout(500);
//     //Now navigate to spreadsheet component 
//     await page.goto("https://ej2.syncfusion.com/demos/#/fluent2/spreadsheet/default.html");
//     await page.setViewportSize({ width: 1920, height: 1080 });
